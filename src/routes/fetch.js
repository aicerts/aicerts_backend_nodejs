...
/**
 * @swagger
 * /api/dynamic-filtered-issues:
 *   post:
 *     summary: Get details of Dynamic QR issued documents by Issuers under particular input:filter as name, documentNumber with flag code (1:partial match, 2:complete match).
 *     description: API to fetch details of certifications issued by Issuers under particular input:filter as name, documentNumber as filter code and flag.
 *     tags: [Fetch/Upload]
 *     security:
 *       - BearerAuth: []
 *     parameters:
 ...
 *               input:
 *                 type: string
 *                 description: Provide filter (name, documentID)
 *               filter:
 *                 type: string
 *                 description: Provide (name / certificateID) target
 *               flag:
 *                 type: number
 *                 description: Provide flag value 
 *             required:
