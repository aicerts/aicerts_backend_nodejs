 ...
 * /api/shorten-url:
 *   post:
 *     summary: API call for encode/decode for the Short URL.
 *     description: API call for encode/decode for the Short URL.
 *     tags:
 *       - URL Shortening encode/decode
 *     requestBody:
 *       required: true
 *       content:
 *         application/json:
 ...
 *     responses:
 *       '200':
 *         description: Successfully encoded/decoded shortening url
 *         content:
 *           application/json:
 *             schema:
 *               type: object
 ...
 *             example:
 *               status: "SUCCESS"
 *               message: encoded/decoded url successfully.
 *               details: Url details.
 *       '400':
 ...
 *             example:
 *               status: "FAILED"
 *               message: Error message for provided url.
 *       '422':
 *         description: User given invalid input (Unprocessable Entity)
 *         content:
 *           application/json:
...
router.post('/shorten-url', validationRoute.checkUrl, adminController.shortenUrlToVerify);
