...
const { handleRenewCertification, handleUpdateCertificationStatus } = require('../services/feature');
...
const updateCertStatus = async (req, res) => {
    ...
    try {
        ...
        const issueResponse = await handleUpdateCertificationStatus(email, certificateNumber, certStatus);
...
const renewCert = async (req, res) => {
    ...
    try {
        ...
        const issueResponse = await handleRenewCertification(email, certificateNumber, _expirationDate);
        var responseDetails = issueResponse.details ? issueResponse.details : '';
        if (issueResponse.code == 200) {
